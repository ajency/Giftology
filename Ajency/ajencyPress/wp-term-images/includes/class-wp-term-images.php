...
final class WP_Term_Images extends WP_Term_Meta_UI {
	...
	public function enqueue_scripts() {
		...
		// Enqueue media handler; includes quick-edit_
		wp_enqueue_style( 'wp-term-images',  get_template_directory_uri() . '/Ajency/ajencyPress/wp-term-images/assets/css/term-image.css', array(),           $this->db_version       );
		wp_enqueue_script( 'wp-term-images', get_template_directory_uri() . '/Ajency/ajencyPress/wp-term-images/assets/js/term-image.js',   array( 'jquery' ), $this->db_version, true );

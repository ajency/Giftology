    ...
    <div class="col-sm-7">
        <div class="data-banner">
            <h1 class="banner-title"><?php  echo $gift->title; ?>
                <?php if(is_user_logged_in && $gift->created_by == get_current_user_id()) : ?>
                    <a href="/?update-gift=<?php echo $gift->id ?>&redirect=/gifts/<?php echo $gift->slug; ?>" class="banner-link">Edit gift details</a>
                <?php endif; ?>
            </h1>
